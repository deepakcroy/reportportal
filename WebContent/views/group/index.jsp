...
<ul class="btn-toolbar"> 
     <li><a onclick="createOrEditForm(this)" data-url="${pageContext.request.contextPath}/setup/group/saveorupdateform"  class="btn btn-green"><i class=" fontello-icon-list-add"></i> <s:property value="getText('button.create')" /> </a></li> 
     <li><a onclick="delete(this)" data-url="${pageContext.request.contextPath}/setup/group/delete" class="btn btn-red"><i class="fontello-icon-trash-1"></i> <s:property value="getText('button.delete')" /> </a> </li>
 </ul>


	<div class="content">
	
	<table id="groupDataTable" class="table table-striped table-bordered table-condensed table-content table-hover boo-table">
	<thead>
	    <tr>
	    	<th>Action</th>
	        <th>Id</th>
...
function createOrEditForm(obj)
{
	...
	// ok button click
		var options = {
				 type: "post",
				 url:'./group/saveorupdate',//+$("#qForm").serialize(),
...
$(document).ready(function() {
	 ...
	 oTable = $('#groupDataTable').dataTable( {
	    //'sScrollX':true,
	 	"bFilter": false,
	 	"bLengthChange": false,
       ...
       // "sAjaxSource": "./userDataTable"+location.search,
        "sAjaxSource": "./group/groupdatatable",
        /* "aoColumns": [
